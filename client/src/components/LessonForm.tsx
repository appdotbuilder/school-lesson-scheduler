...
import type { CreateLessonInput } from '../../../server/src/schema';
...
export function LessonForm({ onSubmit, isLoading = false }: LessonFormProps) {
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="space-y-2">
        ...
        <Select 
          ...
          onValueChange={(value: string) => 
            setFormData((prev: CreateLessonInput) => ({ ...prev, subject: value }))
          }
        >
          <SelectTrigger>
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
            setFormData((prev: CreateLessonInput) => ({ ...prev, teacher: e.target.value }))
          }
      ...
      <div className="space-y-2">
        ...
        <Select 
          ...
          onValueChange={(value: string) => 
            setFormData((prev: CreateLessonInput) => ({ ...prev, classroom: value }))
          }
        >
          <SelectTrigger>
